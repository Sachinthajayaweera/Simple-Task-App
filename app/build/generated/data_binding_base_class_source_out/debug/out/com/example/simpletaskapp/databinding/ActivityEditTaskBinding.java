...
public final class ActivityEditTaskBinding implements ViewBinding {
  ...
  private ActivityEditTaskBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSave,
      @NonNull TextInputEditText editTextDescription, @NonNull TextInputEditText editTextTitle,
      @NonNull TextInputLayout inputLayoutDescription, @NonNull TextInputLayout inputLayoutTitle,
  ...
  public static ActivityEditTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityEditTaskBinding((ConstraintLayout) rootView, btnSave, editTextDescription,
          editTextTitle, inputLayoutDescription, inputLayoutTitle, textHeader);
    }
