...
public final class ActivityAddTaskBinding implements ViewBinding {
  ...
  private ActivityAddTaskBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnSave,
  ...
  public static ActivityAddTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAddTaskBinding((ConstraintLayout) rootView, btnSave, editTextDescription,
