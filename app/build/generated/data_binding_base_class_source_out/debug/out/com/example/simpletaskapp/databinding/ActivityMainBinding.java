...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout emptyView,
      @NonNull FloatingActionButton fabAddTask, @NonNull RecyclerView tasksRecyclerView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, emptyView, fabAddTask,
          tasksRecyclerView, textHeader);
    }
